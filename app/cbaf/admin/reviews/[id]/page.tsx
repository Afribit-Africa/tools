  ...
  return (
    <div className="min-h-screen bg-black pb-20">
      ...
      <div className="max-w-5xl mx-auto px-4 pt-28">
        {/* Header */}
        <div className="mb-6">
          <a href="/cbaf/admin/reviews" className="text-sm text-bitcoin hover:text-bitcoin/80 mb-4 inline-block font-medium">
            ← Back to Reviews
          </a>
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-400">
                <span className="font-medium text-white">{economy?.economyName || 'Unknown Economy'}</span>
                {economy?.country && (
                  <>
                    <span>•</span>
                    ...
                    {duplicateInfo && (
                      <div className="text-sm text-gray-300 space-y-1">
                        ...
                        <a
                          ...
                          className="text-bitcoin hover:text-bitcoin/80 inline-block mt-2 font-medium"
                        >
              ...
              {videoMerchantData.length === 0 ? (
                ...
                <div className="space-y-3">
                  {videoMerchantData.map(({ merchant }) => (
                    merchant && (
                      <div key={merchant.id} className="p-4 bg-white/5 rounded-lg border border-white/10">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-xs text-bitcoin hover:text-bitcoin/80 flex items-center gap-1 font-medium mt-2"
                        >
                          <ExternalLink className="w-3 h-3" />
                          View on BTCMap
                        </a>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {economy.website && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-bitcoin hover:text-bitcoin/80 flex items-center gap-1 font-medium"
                    >
                      <ExternalLink className="w-3 h-3" />
                      Website
                    </a>
