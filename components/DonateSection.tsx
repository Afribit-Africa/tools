...
import { Coffee, Heart, Zap, Copy, Check, ExternalLink, QrCode } from 'lucide-react';
  ...
  return (
    <>
            ...
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-6">
                  ...
                  <button
                    onClick={() => setShowModal(true)}
                    className="sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-bitcoin-500/50 text-white font-medium rounded-xl transition-all"
                  >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  ...
                  {['1K', '5K', '10K', '21K'].map((amount) => (
                    <button
                      key={amount}
                      onClick={() => setShowModal(true)}
                      className="px-3 py-1 bg-white/5 hover:bg-bitcoin-500/20 border border-white/10 hover:border-bitcoin-500/30 rounded-full text-xs text-gray-400 hover:text-bitcoin-400 transition-all"
                    >
                      {amount} sats
                    </button>
                  ))}
      ...
      <DonateModal
        ...
        lightningAddress="edmundspira@blink.sv"
        recipientName="Edmund Spira"
      />
    </>
  );
}
